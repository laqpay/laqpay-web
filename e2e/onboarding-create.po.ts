...
export class OnboardingCreatePage {
  ...
  private fillCreateWalletForm(seedText: string = 'laqpay-web-e2e-test-seed', confirmSeedText: string = 'laqpay-web-e2e-test-seed'): ElementFinder {
  ...
  private fillLoadWalletForm(walletLabel: string = 'Test wallet', seedText: string = 'laqpay-web-e2e-test-seed-load'): ElementFinder {
